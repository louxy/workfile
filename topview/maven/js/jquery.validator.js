...
(function($)
{
	...
	var Data = {
		...
		formats: {
			...
			ip: /^(\d{1,3}\.){3}\d{1,3}$/,
			date: /^\d{2}[- \/.]\d{2}[- \/.]\d{4}$/,
			datetime: /^(\d{2}(([02468][048])|([13579][26]))\/((((0[13578])|(1[02]))\/((0[1-9])|([1-2][0-9])|(3[01])))|(((0[469])|(11))\/((0[1-9])|([1-2][0-9])|(30)))|(02\/((0[1-9])|([1-2][0-9])))))|(\d{2}(([02468][1235679])|([13579][01345789]))\/((((0[13578])|(1[02]))\/((0[1-9])|([1-2][0-9])|(3[01])))|(((0[469])|(11))\/((0[1-9])|([1-2][0-9])|(30)))|(02\/((0[1-9])|(1[0-9])|(2[0-8])))))\s*?([0-1][0-9]|2[0-3])\:[0-5][0-9]\:[0-5][0-9]$/,
			phone: /^\d{10,15}$/,
			zipUS: /^(\d{5})(-\d{4})?$/,
